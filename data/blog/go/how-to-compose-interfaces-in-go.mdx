---
title: How to compose interfaces in go
date: '2023-01-22'
tags: ['go', 'interfaces']
draft: false
summary: 'ADD LATER'
...
[Composition over inhertiance](https://en.wikipedia.org/wiki/Composition_over_inheritance) is a key concept in the go programming language that is often missused. Let's look at the correct way on how to compose interfaces in go.
