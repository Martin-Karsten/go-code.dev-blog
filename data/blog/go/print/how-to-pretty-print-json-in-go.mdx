...
If you want to read more on how to use the print function in go, printing structs in particular, you should check out [this article](https://www.go-code.dev/blog/go/print/how-to-print-a-struct-in-go).
